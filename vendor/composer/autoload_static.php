...
class ComposerStaticInitf0b5dad53b097cfff6573dbeaec4cd3a
{
    public static $classMap = array (
        ...
        'CategoryDB' => __DIR__ . '/../..' . '/model/categorydb.php',
        ...
        'ExerciseDB' => __DIR__ . '/../..' . '/model/exercisedb.php',
        'F3' => __DIR__ . '/..' . '/bcosca/fatfree-core/f3.php',
        'GradesDB' => __DIR__ . '/../..' . '/model/gradedb.php',
        ...
        'UnitDB' => __DIR__ . '/../..' . '/model/unitdb.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInitf0b5dad53b097cfff6573dbeaec4cd3a::$classMap;
