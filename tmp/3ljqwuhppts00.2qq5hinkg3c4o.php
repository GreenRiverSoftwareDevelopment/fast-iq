...
li {
  ...
  <iframe class="embed-responsive-item img-fluid" src="https://www.youtube.com/embed/kvCnjVSpuv0" allowfullscreen></iframe></div>
                ...
                <div id="TEST_3" class="panel-collapse collapse">
                    <div class="panel-body">
						...
						<ul class="list-group">
							...
							<li class="list-group-item"><?= ($exercise['exercise_questions']) ?> </li> 
