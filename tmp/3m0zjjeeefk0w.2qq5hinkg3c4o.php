										...
										<div class="video_fields_wrap">
											...
											<?php foreach (($videos_array?:[]) as $video): ?>
												<div class="row dynamic_input"> 
													<div class="col-sm-10">
														<textarea rows="3" cols="50" class="form-control"  name="videoLink[]" id="!!<?= ($video) ?>" placeholder="Enter a link here" value= "<?= ($video) ?>" style="font-size: 14px"><?= ($video) ?></textarea>
													</div>
													...
													<div class="col-sm-1 text-center">
														<br>
														<span class="glyphicon glyphicon-eye-open view_video" id="!!<?= ($video) ?>" aria-hidden="true"></span>
													</div>
												</div>
												<br>
											<?php endforeach; ?>
