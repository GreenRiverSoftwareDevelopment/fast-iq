            ...
            <br>
                <div class="row">
                    ...
                    <div class="col-sm-6"><div class="panel panel-primary">
      				<div class="panel-heading"><h1>Exercise Summary </h1></div>
                    ...
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6"><div class="panel panel-primary">
      				<div class="panel-heading"><h1>Video</h1></div>
      				<div class="panel-body">
                        <div class="col-sm-2"> <div class="col-sm-1"></div><<iframe width="854" height="480" src="https://www.youtube.com/embed/BX2XfIID7l0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
                    ...
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6"><div class="panel panel-primary">
      				<div class="panel-heading"><h1>Questions</h1> </div>
      				<div class="panel-body">
                    <p>
                        <h1>1) What is science</h1>
                        <h1>1) What is science</h1>
                        <h1>1) What is science</h1>
                        <h1>1) What is science</h1>
                        <h1>1) What is science</h1>
                    ...
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6"><div class="panel panel-primary">
      				<div class="panel-heading"><h1>Photo</h1> </div>
      				<div class="panel-body">
