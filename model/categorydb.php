...
(
    category_id int NOT NULL AUTO_INCREMENT, cateogry_name varchar (255),
    category_image varchar (500), PRIMARY KEY(category_id)
);*/
    ...
    class CategoryDB {
        ...
        function addCategory($category_name) {
            $insert = 'INSERT INTO categories (category_name) VALUES
            (:category_name)';
        ...
        function editCategory($category_name, $category_id) {
            $insert = 'UPDATE categories SET category_name=:category_name WHERE
            category_id=:id';

            $statement = $this->_pdo->prepare($insert);
            $statement->bindValue(':category_name', $category_name,
            PDO::PARAM_INT); $statement->bindValue(':id', $category_id,
            PDO::PARAM_STR);
        ...
        function getCategoryByID($id) {
            $select = 'SELECT category_name, category_id FROM categories WHERE
            category_id=:id';
