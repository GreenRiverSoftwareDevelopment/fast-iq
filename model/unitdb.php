...
/*CREATE TABLE units
(
    unit_id int NOT NULL AUTO_INCREMENT, cateogry_id int, unit_name varchar
    (255), PRIMARY KEY(unit_id)
);*/
    ...
    class UnitDB {
         ...
         * INSERT INTO `units` (`category_id`, `unit_name`) VALUES
            (1, 'Mass 101'), (1, 'Mass over 9000'), (2, 'Electronics: How do
            they work?'), (2, '+ to + right?'), (3, 'What is Pneumatics?'), (3,
            'Ok, but what is Pneumatics'), (4, 'Hydraulics, put it... put it on
            my car'), (4, 'Hydraulic toilets and you'), (5, 'Mechanical is
            everything'), (5, 'Mechanical 485');
         */
        function addUnit($unit_name, $id) {
            $insert = 'INSERT INTO units (category_id, unit_name) VALUES (:id,
            :unit_name)';
        ...
        function editUnit($unit_name, $id) {
            $insert = 'UPDATE units SET unit_name=:unit_name WHERE unit_id=:id';
        ...
        function unitsByCategory($category_id) {
            ...
            $select = "SELECT unit_id, category_id, unit_name FROM units WHERE
            category_id = ".$category_id." ORDER BY unit_name";
        ...
        function getUnitByID($id) {
            $select = 'SELECT category_id, unit_id, unit_name FROM units WHERE
            unit_id=:id';
