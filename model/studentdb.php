...
CREATE TABLE students ( student_id int NOT NULL AUTO_INCREMENT PRIMARY
        KEY, exercise_id int NOT NULL, fName varchar(255), lName varchar(255),
        grade int ); */
    ...
    class StudentDB {
         ...
         *
         * @access public
         * @param string $exercise_id the id of the exercise the student will be
           graded in
        ...
        function addStudent($exercise_id, $fName, $lName, $grade) {
            ...
            $insert = 'INSERT INTO students (exercise_id, fName, lName, grade)
            VALUES (:exercise_id, :fName, :lName, :grade)';
        ...
        function updateStudent($student_id, $exercise_id, $grade) {
            $update = 'UPDATE
                        students SET grade = "'.$grade.'" WHERE student_id =
        ...
        function allStudents() {
            $select = 'SELECT student_id, exercise_id, fName, lName, grade FROM
            students ORDER BY student_id'; $results =
        ...
        function editStudentName($student_id, $fName, $lName) {
            $update = 'UPDATE
                        students SET fName = :fName AND lName = :lName WHERE
